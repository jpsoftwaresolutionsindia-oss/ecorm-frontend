...
const Register = () => {
    ...
    <a target='_blank' href={`${process.env.REACT_APP_ADMIN_URL || 'http://localhost:3001'}/login`}>
     ...
     <a target='_blank' href={`${process.env.REACT_APP_ADMIN_URL || 'http://localhost:3001'}/register`}>
